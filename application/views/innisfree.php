    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/innisfree.jpeg')?>" alt="" width="650px" height="550px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>INNISFREE </strong></h1>
                    <br>
                    <p class="justify">Innisfree adalah brand kecantikan alami ternama dari Korea yang menawarkan produk kecantikan yang terinspirasi oleh, dan dibuat dari bahan-bahan alami dari Pulau Jeju. Hadir di 10 negara, brand innisfree ini telah disukai di seluruh dunia, dan diakui karena inovasi kecantikannya yang terjangkau di harga menengah.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 30.000,- s/d Rp. 60.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Innisfree_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
