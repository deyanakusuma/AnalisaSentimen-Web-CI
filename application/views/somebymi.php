        ...
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                ...
                <div class="col-md-4">
                    ...
                    <br>
                    <p class="justify">Some By Mi merupakan toner yang ditujukan untuk exfoliasi atau mengangkat sel kulit mati. Keunggulan utama dari produk ini adalah karena mengandung tiga jenis bahan exfoliasi sekaligus di dalamnya, yaitu AHA, BHA, dan PHA. Selain mengandung tiga jenis bahan exfoliasi sekaligus, Some By Mi AHA BHA PHA 30 Days Miracle Toner juga mengandung 10.000 ppm Real Tea Tree.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 120.000,- s/d Rp. 200.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('SomeByMi_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
