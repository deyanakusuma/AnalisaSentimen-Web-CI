    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/march.jpg')?>" alt="" width="650px" height="500px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>MARCKS' BEDAK </strong></h1>
                    <br>
                    <p class="justify">Marcks sudah diproduksi lebih dari 50 tahun lalu, tepatnya sejak zaman Belanda. Marcks adalah produk warisan dari perusahaan Belanda. Marcks yang dikenal sebagai bedak tabur dengan kemasan karton sederhana ini memiliki konsumen yang loyal. Bahkan, bedak Marcks menjadi bedak yang direkomendasikan oleh dokter untuk pasien yang wajahnya bermasalah.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 20.000,- s/d Rp. 30.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Marcks_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
