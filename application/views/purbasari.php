    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/purbasari.jpeg')?>" alt="" width="650px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>PURBASARI </strong></h1>
                    <br>
                    <p class="justify">Purbasari adalah sebuah brand kecantikan Indonesia yang bernaung di bawah PT Gloria Origita Cosmetics. Purbasari tidak berhenti hanya pada heritage kecantikan Indonesia, melainkan turut serta mengikuti dan membuat trend kecantikan modern.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 20.000,- s/d Rp. 40.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Purbasari_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
