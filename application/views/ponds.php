    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/ponds.jpg')?>" alt="" width="650px" height="500px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>POND'S </strong></h1>
                    <br>
                    <p class="justify">Pond's adalah sebuah perusahaan produsen krim kecantikan dan kesehatan yang merupakan sebuah perusahaan multinasional dibawah Unilever. Hingga sekarang, produk kecantikan ini hadir di seluruh lapisan dunia, seperti di Spanyol, India, Jepang, Thailand dan juga Ponds Indonesia.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 15.000,- s/d Rp. 30.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Ponds_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
