    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/freeman.jpg')?>" alt="" width="500px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>FREEMAN BEAUTY </strong></h1>
                    <br>
                    <p class="justify">Freeman adalah salah satu produk masker yang sering menjadi incaran semua orang. Freeman memiliki varian bentuk yang sangat banyak yaitu clay mask, sheet mask, mud mask, gel mask, dll.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 70.000,- s/d Rp. 100.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Freeman_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
