    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/emina.jpg')?>" alt="" width="650px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>EMINA COSMETICS </strong></h1>
                    <br>
                    <p class="justify">Emina adalah brand terbaru yang merupakan "adik" dari Wardah dan Make Over. Emina hadir untuk kamu para pemula yang ingin mencoba hal baru dalam dunia kecantikan.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 25.000,- s/d Rp. 105.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Emina_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
