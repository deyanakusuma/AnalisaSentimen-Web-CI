    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/cleanclear.jpg')?>" alt="" width="500px" height="500px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>CLEAN AND CLEAR </strong></h1>
                    <br>
                    <p class="justify">Clean and Clear adalah salah satu produk yang berasal dari Amerika yang dimiliki oleh Johnson & Johnson. Produk ini mirip dengan Neutrogena namun dengan harga yang lebih murah. Sebagian besar produk ini ditujukan untuk remaja, tetapi beberapa mengobati berbagai kondisi kulit yang lebih banyak.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 17.000,- s/d Rp. 30.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('CleanClear_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
