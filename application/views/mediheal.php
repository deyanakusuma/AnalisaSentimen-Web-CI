    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/mediheal.jpg')?>" alt="" width="650px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>MEDIHEAL </strong></h1>
                    <br>
                    <p class="justify">Mediheal adalah salah satu merk produk kecantikan yang berasal dari Korea Selatan. Saat ini mediheal sangat terkenal lantaran produk sheetmask yang ditawarkan.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 40.000,- s/d Rp. 250.000,-</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Mediheal_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
