    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/wardah.jpg')?>" alt="" width="650px" height="550px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>WARDAH BEAUTY</strong></h1>
                    <br>
                    <p class="justify">Wardah adalah sebuah brand kecantikan yang peduli dan mengerti keinginan setiap perempuan untuk selalu memiliki perasaan tenang dan nyaman dengan penampilannya. Wardah sebagai pelopor dalam menciptakan produk kecantikan bersertifikat halal, membagikan pemahaman baru bahwa cara hidup halal dan produk kecantikan mampu berpadu secara elegan.</p> 
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Wardah_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
