    ...
    <section id="categories">
        <div class="container">
            <div class="row pad-bottom" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="col-md-7">
                    <img src="<?php echo base_url('assets/img/hadolabo.jpg')?>" alt="" width="650px" height="500px"/>
                </div>
                <div class="col-md-4">
                    <h1><strong>HADOLABO </strong></h1>
                    <br>
                    <p class="justify">Hada Labo  adalah rangkaian perawatan kulit wajah yang dikembangkan oleh Rohto Pharmaceutical Japan   dengan pengawasan ketat berstandar farmasi GMP untuk menjamin kualitas produk dan kepuasan konsumen. Hada Labo hanya mengandung bahan-bahan yang berkualitas, penting dan baik untuk kulit dan tidak mengandung bahan tambahan lain yang tidak diperlukan oleh kulit.Dengan PH yang disesuaikan dengan PH kulit, sehingga dapat menghindarkan dampak iritasi pada kulit.</p> 
                    <br>
                    <h4 style="color:Gray;">Harga</h4>
                    <p>Rp. 30.000,- s/d Rp. 190.000,-</p>
                    <br>
                    <h4 style="color:Gray;">Batas Usia</h4>
                    <p>Remaja hingga Dewasa</p>
                    <br>
							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('HadoLabo_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
