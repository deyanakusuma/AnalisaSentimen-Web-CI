							...
							<tbody>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column5">
                                        <a class="btn btn-success" href="<?php echo site_url('Viva_C/edit/'.$opini->id) ?>" class="edit">Hasil Sentimen</a>
                                    </td>
